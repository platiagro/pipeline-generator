...
class TestOperators(TestCase):
    ...
    def test_get_logs(self):
        with app.test_client() as c:
            rv = c.get(f"/trainings/{EXPERIMENT_ID}/operators/{OPERATOR_ID}/logs")
            result = rv.get_json()
            ...
            rv = c.get(f"/trainings/{EXPERIMENT_ID}/operators/{WRONG_OPERATOR_ID}/logs")
            result = rv.get_json()
            ...
            # ------------------------------------------------------------------------------------------------
            # rv = c.get(f"/trainings/{EXPERIMENT_ID}/operators/{OPERATOR_ID_2}/logs")
            # result = rv.get_json()
